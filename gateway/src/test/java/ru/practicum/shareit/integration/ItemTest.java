...
public class ItemTest {
    ...
    void testGetItemById() throws Exception {
        ...
        gatewayApi.getItemById(item.getId())
    ...
    void testGetUserItems() throws Exception {
        ...
        gatewayApi.getUserItems(user.getId())
                .andExpect(status().isOk())
    ...
    void testItemsSearch() throws Exception {
        ...
        gatewayApi.itemsSearch(user.getId(), item.getName())
                .andExpect(status().isOk())
    ...
    void testCreateItem() throws Exception {
        ...
        gatewayApi.createItem(user.getId(), item)
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id").value(greaterThan(0)))
                .andExpect(jsonPath("$.name").value(item.getName()))
                .andExpect(jsonPath("$.description").value(item.getDescription()))
    ...
    void testUpdateItem() throws Exception {
        ...
        gatewayApi.updateItem(user.getId(), item.getId(), item)
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id").value(greaterThan(0)))
                .andExpect(jsonPath("$.name").value(item.getName()))
                .andExpect(jsonPath("$.description").value(item.getDescription()))
    ...
    void testAddComment() throws Exception {
        ...
        gatewayApi.addComment(booker.getId(), item.getId(), request)
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id").value(greaterThan(0)))
